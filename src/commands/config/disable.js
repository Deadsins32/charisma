...
module.exports = {
    config: {
        ...
        description: 'disables a local boolean value',
        hidden: false,
        nsfw: false,
    ...
    command: function(imports, parameters) {
        ...
        if (index(references, parameters[0]) != undefined) {
            ...
            if (typeof type == 'object' || typeof index(references, parameters[0]) == 'object') { embed.setDescription(`\`${parameters[0]}\` isn't an individual property`) }
                ...
                if (type == 'boolean') {
                    if (index(references, parameters[0]) == false) { embed.setDescription(`\`${parameters[0]}\` is already disabled`) }
                    else { index(references, parameters[0], false); embed.setDescription(`\`${parameters[0]}\` has been disabled`) }
                }
            }
        }

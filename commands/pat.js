...
module.exports = function(imports, arguments) {
    ...
    if (imports.user.id == arguments[0]) {
        ...
        imports.message.channel.send(imports.Flavors.variables(imports.Flavors.pick(imports.localsettings.guild.flavor, 'pat', 'bot'), [{ name: 'user', value: imports.user.displayName }]));
    }
